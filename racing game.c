...
cout<<"\n\n\n\n\n\t\t\t* VEHICLE RACING GAME";
cout<<"\n\t\t\t -------------------------------";
cout<<"\n\n\t 1.CONTROL YOUR CAR USING ARROW KEYS";
cout<<"\n\n\t2.PREVENT ABSTACLES";
cout<<"\n\n\t3.YOU HAVE THREE LIVES ";
cout<<"\n\n\t4.AFTER PASSING EACH OBSTACLE YOU EARN SOME POINTS";
cout<<"\n\n\t5.AFTER TOUCHING AN OBSTACLE YOU LOOSE ONE LIFE";
cout<<"\n\n\t6.EARN MAXIMUM POINTS YOU CAN EARN";
cout<<"\n\n\t7.So all the best
{
setcolor(8);
rectangle(x+1,y,x+49,y+100);
